        ...
        <div class="card-body p-4">
          <div class="invoice-wrap">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="invoice-address text-start mb-4">
                  ...
                  <p>Address: <span>{{ dataObj.selectedCustomer.address || 'N/A' }}</span></p>
                  <p>Email: <span>{{ dataObj.selectedCustomer.email || 'N/A' }}</span></p>
                </div>
              </div>
            </div>
              ...
              <table class="table table-bordered">
                <thead class="table-light text-white bg-primary">
                  ...
                  <tr>
                    ...
                    <th>
                      <input type="text" class="form-control" :value="calculatedSubtotal" disabled>
                    </th>
                    <th>
            ...
            <div class="d-flex justify-content-end mt-4">
              <button @click="processOrder" class="btn btn-success">Process</button>
            </div>
          </div>
        </div>
      </div>
